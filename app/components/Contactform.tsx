		...
		<div className="bg-white px-6 py-20 sm:py-28 lg:px-8">
			<div className="mx-auto max-w-2xl text-center">
				<h2 className="text-3xl text-gray-500">
					Contact <span className="text-[#5d6b48]">Me</span>
				</h2>
			</div>
			<form onSubmit={handleSubmit} className="mx-auto mt-10 max-w-xl sm:mt-14">
				...
				{error && (
					<div className="w-full p-4 my-4 text-sm text-red-800 rounded-lg bg-red-50" role="alert">
						<span className="font-medium">{error}</span>
					</div>
				)}

				{success && (
					<div className="w-full p-4 my-4 text-sm text-green-800 rounded-lg bg-green-50" role="alert">
