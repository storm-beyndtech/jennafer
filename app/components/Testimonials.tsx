      ...
      <div className="overflow-hidden bg-gray-900">
        <div className="relative max-ctn max-md:px-4 py-10 lg:py-14">
          ...
          <div className="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
            <div>
              <h4 className="text-lg sm:text-xl font-semibold text-[#c7d1b3a7]">Accuracy rate</h4>
              <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-[#c7d1b3]">99.99%</p>
              <p className="mt-1 text-gray-400">in fulfilling orders</p>
            </div>

            <div>
              <h4 className="text-lg sm:text-xl font-semibold text-[#c7d1b3a7]">Licences</h4>
              <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-[#c7d1b3]">20+</p>
              <p className="mt-1 text-gray-400">across states</p>
            </div>

            <div>
              <h4 className="text-lg sm:text-xl font-semibold text-[#c7d1b3a7]">Happy Clients</h4>
              <p className="mt-2 sm:mt-3 text-4xl sm:text-6xl font-bold text-[#c7d1b3]">98%</p>
